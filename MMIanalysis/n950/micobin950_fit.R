...
saveRDS(fit_micobin1, file = "res/fit_micobin1_n950.rds")
set.seed(22)
fit_micobin2 = spmicobinreg(MMI_BENT ~ agkffact_logstd + bfi_logstd +
                            ...
                            nngp.control = list(n.neighbors = 15, ord = o),
                            nburn = 1000, nsave = 5000)
saveRDS(fit_micobin2, file = "res/fit_micobin2_n950.rds")
set.seed(222)
fit_micobin3 = spmicobinreg(MMI_BENT ~ agkffact_logstd + bfi_logstd +
                            ...
                            nngp.control = list(n.neighbors = 15, ord = o),
                            nburn = 1000, nsave = 5000)
saveRDS(fit_micobin3, file = "res/fit_micobin3_n950.rds")
}else{
  fit_micobin1 = readRDS("res/fit_micobin1_n950.rds")
  fit_micobin2 = readRDS("res/fit_micobin2_n950.rds")
  fit_micobin3 = readRDS("res/fit_micobin3_n950.rds")
}
...
saveRDS(list(
  ...
  file = "res/summary_micobin_n950.rds")
