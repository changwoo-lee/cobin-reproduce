...
if(RUN){
  ...
  saveRDS(fit_betarec1, file = "res/fit_betarec1_n947.rds")
  fit_betarec2 = rstan::stan(file = "betarecreg_spatial_NNGP.stan",
                             data = stan_data,
                             chains = 1, seed = 44,
                             iter = nburn + nsave, warmup = nburn, thin = nthin)
  saveRDS(fit_betarec2, file = "res/fit_betarec2_n947.rds")
  fit_betarec3 = rstan::stan(file = "betarecreg_spatial_NNGP.stan",
                             data = stan_data,
                             chains = 1, seed = 444,
                             iter = nburn + nsave, warmup = nburn, thin = nthin)
  saveRDS(fit_betarec3, file = "res/fit_betarec3_n947.rds")
}else{
  fit_betarec1 = readRDS("res/fit_betarec1_n947.rds")
  fit_betarec2 = readRDS("res/fit_betarec2_n947.rds")
  fit_betarec3 = readRDS("res/fit_betarec3_n947.rds")
}
...
saveRDS(list(
  ...
  file = "res/summary_betarec_n947.rds")
