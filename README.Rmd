...
See cobin_1.0.0.1.pdf for the package documentation (anonymized) or type `?(function_name)` for details. Test if the package is installed correctly, e.g. Kolmogorov-Gamma sampler:
